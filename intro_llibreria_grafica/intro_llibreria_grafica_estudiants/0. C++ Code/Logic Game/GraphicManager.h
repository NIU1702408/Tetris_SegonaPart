...
typedef enum
{
    ...
    GRAFIC_QUADRAT_VERD,
    GRAFIC_QUADRAT_GROC_SHADOW,
    GRAFIC_QUADRAT_BLAUCEL_SHADOW,
    GRAFIC_QUADRAT_MAGENTA_SHADOW,
    GRAFIC_QUADRAT_TARONJA_SHADOW,
    GRAFIC_QUADRAT_BLAUFOSC_SHADOW,
    GRAFIC_QUADRAT_VERMELL_SHADOW,
    GRAFIC_QUADRAT_VERD_SHADOW,
    GRAFIC_QUADRAT_GROC_SMALL,
    GRAFIC_QUADRAT_BLAUCEL_SMALL,
    GRAFIC_QUADRAT_MAGENTA_SMALL,
    GRAFIC_QUADRAT_TARONJA_SMALL,
    GRAFIC_QUADRAT_BLAUFOSC_SMALL,
    GRAFIC_QUADRAT_VERMELL_SMALL,
    GRAFIC_QUADRAT_VERD_SMALL,
    GRAFIC_NUM_MAX
} IMAGE_NAME;
